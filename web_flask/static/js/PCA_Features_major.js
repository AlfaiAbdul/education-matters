...
d3.csv("js/my_dataNoZeros1.csv", function(err, mydata) {
	if (err) throw err;
			...
			function findMinAndMax(dataColumnX) {
				...
				yMax = d3.max(mydata, function(data) {
					return +data.MN_EARN_WNE_P10 * 1.5;
				});

				yMin = d3.min(mydata, function(data){
					return +data.MN_EARN_WNE_P10 * 0.3;
			...
			var toolTip = d3.tip()
					...
					.html(function(data) {
						...
						if (currentAxisLabelY === 'MN_EARN_WNE_P10') {
							yinfo = "MN_EARN_WNE_P10:" + MN_EARN_WNE_P10
						}
